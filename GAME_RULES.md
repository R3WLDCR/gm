...
- てるてるは第3陣営。追放または襲撃により死亡した時点でてるてる陣営の勝利となる。複数指定できる。
...
- てるてるが追放または襲撃により死亡した場合はてるてる陣営の勝利。
...
| ハンター道連れ | `startHunterShotFlow()` / `confirmHunterShot()` | 追放後、襲撃後、連鎖道連れ、てるてる道連れ、勝敗判定、円卓表示、ログ |
