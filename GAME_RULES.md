...
- 準備ログには参加者ごとの参加・休み、配役開始、個別の役職を決定した記録を表示せず、配役完了など進行に必要な記録だけを残す。
...
| 準備ログ | `isHiddenPreparationLog()` / `groupLogsByDay()` | 参加・休み、配役開始、個別役職決定、現在ログ、保存済みログ、ログコピー、配役完了ログ、日別ブロック順 |
